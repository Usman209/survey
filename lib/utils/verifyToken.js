...
// const jwt = require('jsonwebtoken');
// const { findById } = require('your-models');  // Import your model for user data (adjust as necessary)
// const { sendResponse, EResponseCode } = require('your-utils'); // Import your response utility (adjust as necessary)

// // Predefined UC lists for each tehsilOrTown
// const territoryUCs = {
//   Wahga: ["37A", "37B", "38", "39A", "39B", "40A", "40B", "42", "49A", "49B", "50A", "50B", "51A", "51B", "52A", "52B", "52C", "52D", "53A", "53B", "62A", "62B", "62C", "65A", "65B"],
//   AllamaIqbal: ["110A", "110B", "111", "112A", "112B", "113", "114", "116A", "116B", "116C", "117A", "117B", "117C", "118A", "118B", "118C", "119A", "119B", "119C", "120A", "120B", "120C", "120D", "120E", "120F", "120G", "120H", "121A", "121B", "122A", "122B", "122C", "122D", "122E", "123A", "123B", "124A", "124B", "125A", "125B", "132P", "132", "133P", "133", "148A", "148B", "148C", "149A", "149B", "151P", "151"],
//   AzizBhatti: ["41A", "41B", "43A", "43B", "44A", "44B", "45", "48", "54", "55", "56", "57A", "57B", "58", "59", "60A", "60B", "60C", "61A", "61B"],
//   // Add other territories and their corresponding UC arrays similarly
// };
...
//           const allowedUCs = territoryUCs[userToUpdateTerritory];
//           if (!allowedUCs || !allowedUCs.includes(userToUpdateUC)) {
//             return sendResponse(res, EResponseCode.UNAUTHORIZED, 'User UC is not allowed in this territory');
//           }
//         }
//       }
